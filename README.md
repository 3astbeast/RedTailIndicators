...
<p align="center">
  <i>All indicators are free to use. If you find them helpful, donations are always appreciated but never required. if you'd like to use some of my code for a project you're working on, please ask, I'd love to talk. Under no circumstance is anyone allowed to take my code, re brand it and sell it for profit. Trade Devils and Affordable Indicators, this message is directed at you. These indicators are meant to be free and open source. Always.</i>
</p>
